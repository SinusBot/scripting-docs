// this is for testing purposes to check the implementation of Sinusbot typings
/// <reference path="../typings/external/command.d.ts" />
import { VarType } from "@sinusbot"
import { GroupArgumentType } from "external/command";
...
registerPlugin({
  ...
  class GroupArgument extends Argument {
    private _type: GroupArgumentType
    ...
    validate(args) {
      switch (this._type) {
        case GroupArgumentType.OR: return this._validateOr(args)
        case GroupArgumentType.AND: return this._validateAnd(args)
